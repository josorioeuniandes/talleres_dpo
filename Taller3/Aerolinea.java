...
public class Aerolinea
{
    ...
    public void programarVuelo( String fecha, String codigoRuta, String nombreAvion ) throws Exception
    {
        ...
        if (ruta == null || elAvion == null) {
            throw new Exception("Ruta o Avión no encontrados");
        }

        // Crear el vuelo y agregarlo a la lista
        Vuelo nuevoVuelo = new Vuelo(fecha, ruta, elAvion);
    ...
    public int venderTiquetes( String identificadorCliente, String fecha, String codigoRuta, int cantidad ) throws VueloSobrevendidoException, Exception
    {
        ...
        if (cliente == null || vuelo == null) {
            throw new Exception("Cliente o Vuelo no existen");
        }

        // El método venderTiquetes en la clase Vuelo debería encargarse de la lógica de capacidad
        return vuelo.venderTiquetes(cliente, null, cantidad);
    }
    ...
    public void registrarVueloRealizado( String fecha, String codigoRuta )
    {
    	Vuelo vuelo = getVuelo(codigoRuta, fecha);
        if (vuelo != null) {
            vuelo.registrarRealizado(); // Marca el vuelo como completado
        }    }
